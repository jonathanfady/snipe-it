...
class AssetsController extends Controller
{
    ...
    public function index(Request $request, $audit = null)
    {
        ...
        if ($request->filled('current_company_id')) {
            $assets->where('assets.current_company_id', '=', $request->input('current_company_id'));
        }
        ...
        switch ($sort_override) {
            ...
            case 'current_company':
                $assets->OrderCurrentCompany($order);
                break;
            case 'location':
    ...
    public function store(Request $request)
    {
        ...
        $asset->current_company_id      = Company::getIdForCurrentUser($request->get('current_company_id'));
