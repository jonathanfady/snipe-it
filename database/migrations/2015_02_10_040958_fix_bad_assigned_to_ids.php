...
class FixBadAssignedToIds extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('status_labels')->insert([
            ['user_id' => 1, 'name' => 'In Stock', 'deployable' => 1, 'pending' => 0, 'archived' => 0, 'notes' => 'These assets are ready to deploy.'],
            ['user_id' => 1, 'name' => 'In Maintenance', 'deployable' => 0, 'pending' => 1, 'archived' => 0, 'notes' => 'These assets are not yet ready to be deployed, usually because of configuration or waiting on parts.'],
