    ...
    return {
      ...
      columnOptions: {
        ...
        users: [
          ...
          { id: "location", text: "Location" },
          { id: "location_parent", text: "Location Parent" },
          { id: "location_parent_manager_email", text: "Location Parent Manager (Email)" },
          { id: "location_parent_manager_first_name", text: "Location Parent Manager (First Name)" },
          { id: "location_parent_manager_last_name", text: "Location Parent Manager (Last Name)" },
          { id: "location_manager_email", text: "Location Manager (Email)" },
          { id: "location_manager_first_name", text: "Location Manager (First Name)" },
          { id: "location_manager_last_name", text: "Location Manager (Last Name)" },
          { id: "department", text: "Department" },
