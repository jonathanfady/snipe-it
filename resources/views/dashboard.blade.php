    ...
    <div class="col-lg-3 col-xs-6">
        <a href="{{ route('hardware.index') }}">
            ...
            <div class="small-box bg-teal">
                ...
                <a href="{{ route('hardware.index') }}" class="small-box-footer">{{ trans('general.moreinfo') }} <i
    ...
    <div class="col-lg-3 col-xs-6">
        <a href="{{ route('licenses.index') }}">
            ...
            <div class="small-box bg-maroon">
                ...
                <a href="{{ route('licenses.index') }}" class="small-box-footer">{{ trans('general.moreinfo') }} <i
                        class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
                @endcan
            </div>
        </a>
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <a href="{{ route('accessories.index') }}">
            <div class="small-box bg-orange">
                ...
                <a href="{{ route('accessories.index') }}" class="small-box-footer">{{ trans('general.moreinfo') }} <i
                        class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
                @endcan
            </div>
        </a>
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <a href="{{ route('consumables.index') }}">
            <div class="small-box bg-purple">
                ...
                <a href="{{ route('consumables.index') }}" class="small-box-footer">{{ trans('general.moreinfo') }} <i
                        class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
                @endcan
            </div>
    </div><!-- ./col -->
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p><strong>It looks like you haven't added anything yet, so we don't have anything awesome to
                                display. Get started by adding some assets, accessories, consumables, or licenses
                                now!</strong></p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <a class="btn bg-maroon" style="width: 100%" href="{{ route('licenses.create') }}">New
                            License</a>
                        @endcan
                    </div>
                    <div class="col-md-3">
                        @can('create', \App\Models\Accessory::class)
                        <a class="btn bg-orange" style="width: 100%" href="{{ route('accessories.create') }}">New
                            Accessory</a>
                        @endcan
                    </div>
                    <div class="col-md-3">
                        @can('create', \App\Models\Consumable::class)
                        <a class="btn bg-purple" style="width: 100%" href="{{ route('consumables.create') }}">New
                            Consumable</a>
                        @endcan
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table data-cookie-id-table="dashCategorySummary" data-height="400" data-pagination="true"
                                data-side-pagination="server" data-sort-order="desc" data-sort-field="assets_count"
                                id="dashCategorySummary" class="table table-striped snipe-table"
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table data-cookie-id-table="dashModelSummary" data-height="400" data-pagination="true"
                                data-side-pagination="server" data-sort-order="desc" data-sort-field="assets_count"
                                id="dashModelSummary" class="table table-striped snipe-table"
                                data-url="{{ route('api.models.index', ['sort' => 'assets_count', 'order' => 'asc']) }}">

                                <thead>
                                    <tr>
                                        <th class="col-sm-3" data-visible="true" data-field="name"
                                            data-formatter="modelsLinkFormatter" data-sortable="true">
                                            {{ trans('general.name') }}
                                        </th>
                                        <th class="col-sm-3" data-visible="true" data-field="manufacturer"
                                            data-formatter="manufacturersLinkObjFormatter" data-sortable="true">
                                            {{ trans('general.manufacturer') }}
                                        </th>
                                        <th class="col-sm-3" data-visible="true" data-field="category"
                                            data-formatter="categoriesLinkObjFormatter" data-sortable="true">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table data-cookie-id-table="dashLocationSummary" data-height="400" data-pagination="true"
                                data-side-pagination="server" data-sort-order="desc" data-sort-field="assets_count"
                                id="dashLocationSummary" class="table table-striped snipe-table"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-sm-1" data-visible="true" data-field="assigned_assets_count"
                                            ...
                                            <span class="sr-only">Assigned Asset Count</span>
                                        </th>
                                    </tr>
                                </thead>
                            </table>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            <table data-cookie-id-table="dashActivityReport" data-height="400" data-pagination="false"
                                data-id-table="dashActivityReport" data-side-pagination="server" data-sort-order="desc"
