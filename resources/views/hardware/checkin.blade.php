        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <div class="col-md-12">
                    ...
                    autocomplete="off">
                    @else --}}
                    <form class="form-horizontal" method="post" action="{{ route('checkin/hardware', $asset->id) }}"
                        autocomplete="off">
                        {{-- @endif --}}
                        {{csrf_field()}}
                            ...
                            <div class="col-md-8">
                                <p class="form-control-static">
                                    ...
                                    <span class="text-danger text-bold">
                                        ...
                                        The asset <a href="{{ route('hardware.edit', $asset->id) }}">should be
                                            edited</a> to correct this before attempting to check it in or
                                        out.</span>
                                    @endif
                                </p>
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('status_id') ? ' has-error' : '' }}">
                            ...
                            <div
                                class="col-md-7 col-sm-11 @if(\App\Helpers\Helper::checkIfRequired($asset, 'status_id')) required @endif">
                                {{ Form::select('status_id', $statusLabel_list , old('status_id', $asset->status_id), array('class'=>'select2 status_id', 'style'=>'width:100%','id'=>'status_select_id', 'aria-label'=>'status_id', 'data-validation' => ((\App\Helpers\Helper::checkIfRequired($asset, 'status_id')) ? "required" : ""))) }}
                        ...
                        trans('general.location'), 'fieldname' => 'location_id', 'help_text' => ($asset->defaultLoc)
                        ? 'You can choose to check this asset in to a location other than the default location of
                        '.$asset->defaultLoc->name.' if one is set.' : null])
                        ...
                        <div class="form-group{{ $errors->has('checkin_at') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <div class="input-group col-md-5 required">
                                    ...
                                    {!! $errors->first('checkin_at', '<span class="alert-msg" aria-hidden="true"><i
                                            class="fa fa-times" aria-hidden="true"></i> :message</span>') !!}
                                </div>
                            </div>
                        </div>
