...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="alert alert-danger">
            ...
            You must <a href="{{ route('restore/hardware', $asset->id) }}">restore it</a> before you can assign it to
            someone.
        </div>
    </div>
    @endif
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="container row-striped">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <strong>{{ trans('admin/hardware/form.focal_point') }}</strong>
                                    </div>
                                    <div class="col-md-6">
                                        {!! $asset->focal_point->present()->glyph() !!}
                                        {!! $asset->focal_point->present()->nameUrl() !!}
                                    </div>
                                </div>
                                @endif
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12 text-center" style="padding-bottom: 15px;">
                                <a href="{{ ($asset->getImageUrl()) ? $asset->getImageUrl() : null }}"
                                    ...
                                    <img src="{{ ($asset->getImageUrl()) ? $asset->getImageUrl() : null }}"
                                        class="assetimg img-responsive" alt="{{ $asset->getDisplayNameAttribute() }}">
                                </a>
                            </div>
                            @endif
                            ...
                            <p>
                                ...
                                <img src="{{ $asset->assignedTo->present()->gravatar() }}" class="user-image-inline"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table data-columns="{{ \App\Presenters\AssetPresenter::dataTableLayout() }}"
                                    ...
                                    data-sort-order="asc" id="assetsListingTable"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <table data-columns="{{ \App\Presenters\AssetMaintenancesPresenter::dataTableLayout() }}"
                                ...
                                data-show-columns="true" data-show-refresh="true" data-show-export="true"
                                data-export-options='{
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-striped snipe-table" id="assetHistory" data-pagination="true"
                                ...
                                data-show-columns="true" data-show-refresh="true" data-sort-order="desc"
                                data-sort-name="created_at" data-show-export="true" data-export-options='{
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-sm-2" data-field="log_meta" data-visible="true"
                                            data-formatter="changeLogFormatter">Changed</th>
                                    </tr>
                                </thead>
                            </table>
                ...
                <div class="tab-pane fade" id="files">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <table class="table table-striped snipe-table" id="assetFileHistory" data-pagination="true"
                                data-id-table="assetFileHistory" data-search="true" data-side-pagination="client"
                                data-show-columns="true" data-show-refresh="true" data-sort-order="desc"
                                data-sort-name="created_at" data-show-export="true" data-export-options='{
                         ...
                         "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><i class="{{ \App\Helpers\Helper::filetype_icon($file->filename) }} icon-med"
                                        ...
                                        <td>
                                            ...
                                            <a class="btn delete-asset btn-sm btn-danger btn-sm"
                                                ...
                                                data-content="{{ trans('general.delete_confirm', ['item' => $file->filename]) }}"><i
                                                    class="fa fa-trash icon-white" aria-hidden="true"></i></a>
                                            @endcan
                                        </td>
                                    </tr>
                                    @endforeach
