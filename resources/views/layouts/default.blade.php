                    ...
                    <div class="left-navblock">
                        ...
                        <a class="logo navbar-brand no-hover" href="{{ url('/') }}">
                            ...
                            <img class="navbar-brand-img"
                                src="{{ Storage::disk('public')->url('/').e($snipeSettings->logo) }}"
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview{{ (Request::is('hardware*') ? ' active' : '') }}">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{ route('statuslabels.show', ['statuslabel' => $status_nav->id]) }}"><i
                                        class="fa fa-circle text-grey" aria-hidden="true"></i>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li>
                                <a href="{{ route('models.index') }}" {{ (Request::is('/assetmodels')
                                    ? ' class="active"' : '' ) }}>
                                    {{ trans('general.asset_models') }}
                                    ({{ \App\Models\AssetModel::count() }})
                                </a>
                            </li>
                            @endcan
                            ...
                            <li>
                                <a href="{{ route('categories.index') }}" {{ (Request::is('/categories')
                                    ? ' class="active"' : '' ) }}>
                            ...
                            <li>
                                <a href="{{ route('manufacturers.index') }}" {{ (Request::is('/manufacturers')
                                    ? ' class="active"' : '' ) }}>
                                    {{ trans('general.manufacturers') }}
                                    ({{ \App\Models\Manufacturer::count() }})
                                </a>
                            </li>
                            @endcan
                            ...
                            <li>
                                <a href="{{ route('suppliers.index') }}" {{ (Request::is('/suppliers')
                                    ? ' class="active"' : '' ) }}>
                            ...
                            <li>
                                <a href="{{ route('companies.index') }}" {{ (Request::is('/companies')
                                    ? ' class="active"' : '' ) }}>
                            ...
                            <li>
                                <a href="{{ route('depreciations.index') }}" {{ (Request::is('/depreciations')
                                    ? ' class="active"' : '' ) }}>
                                    {{ trans('general.depreciation') }}
                                    ({{ \App\Models\Depreciation::count() }})
                                </a>
                            </li>
                            @endcan
                    ...
                    <li class="treeview{{ (Request::is('reports*') ? ' active' : '') }}">
                        ...
                        <ul class="treeview-menu">
                            <li>
                                <a href="{{ route('reports.activity') }}" {{ (Request::is('reports/activity')
                                    ? ' class="active"' : '' ) }}>
                                    {{ trans('general.activity_report') }}
                                </a>
                            </li>

                            <li><a href="{{ route('reports.audit') }}" {{ (Request::is('reports.audit')
                                    ? ' class="active"' : '' ) }}>
                                    {{ trans('general.audit_report') }}</a>
                            </li>
                            <li>
                                <a href="{{ url('reports/depreciation') }}" {{ (Request::is('reports/depreciation')
                                    ? ' class="active"' : '' ) }}>
                                    {{ trans('general.depreciation_report') }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('reports/licenses') }}" {{ (Request::is('reports/licenses')
                                    ? ' class="active"' : '' ) }}>
                            ...
                            <li>
                                <a href="{{ url('reports/accessories') }}" {{ (Request::is('reports/accessories')
                                    ? ' class="active"' : '' ) }}>
                                    {{ trans('general.accessory_report') }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('reports/custom') }}" {{ (Request::is('reports/custom')
                                    ? ' class="active"' : '' ) }}>
