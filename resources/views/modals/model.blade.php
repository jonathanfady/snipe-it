        ...
        <div class="modal-body">
            <form action="{{ route('api.models.store') }}" onsubmit="return false">
                ...
                <div class="dynamic-form-row">
                    ...
                    <div class="col-md-7 col-xs-12 required">
                    ...
                    <div class="col-md-1 col-xs-12 text-left">
                        <a href='{{ route('modal.show', 'submodals.manufacturer') }}' data-toggle="modal" data-target="#createSubModal" data-select='modal-manufactuer_id' class="btn btn-sm btn-primary">New</a>
                ...
                <div class="dynamic-form-row">
                    ...
                    <div class="col-md-1 col-xs-12 text-left">
                        <a href='{{ route('modal.show', 'submodals.category') }}' data-toggle="modal" data-target="#createSubModal" data-select='modal-category_id' class="btn btn-sm btn-primary">New</a>
                        <span class="mac_spinner" style="padding-left: 10px; color: green; display:none; width: 30px;">
                            <i class="fa fa-spinner fa-spin" aria-hidden="true"></i>
                        </span>
                    </div>
                ...
                <div class="dynamic-form-row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        {{ Form::select('fieldset_id', \App\Helpers\Helper::customFieldsetList(),Request::old('fieldset_id'), array('class'=>'select2', 'id'=>'modal-fieldset_id', 'style'=>'width:350px')) }}
                    </div>
                </div>
        </div>
