...
<form action="{{ route('setup.user.save') }}" method="POST">
    ...
    <div class="col-lg-12" style="padding-top: 20px;">
        ...
        <div class="row">
            ...
            <!-- Language -->
            <div
                class="form-group col-lg-6{{  (\App\Helpers\Helper::checkIfRequired(\App\Models\User::class, 'default_language')) ? ' required' : '' }} {{$errors->has('default_language') ? 'error' : ''}}">
            ...
            <!-- Currency -->
            <div
                class="form-group col-lg-6{{  (\App\Helpers\Helper::checkIfRequired(\App\Models\User::class, 'default_currency')) ? ' required' : '' }} {{$errors->has('default_currency') ? 'error' : ''}}">
        ...
        <div class="row">
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" value="1"
                            name="auto_increment_assets">{{trans('admin/settings/general.auto_increment_assets')}}
                    </label>
                </div>
            </div>
            ...
            <div class="form-group col-lg-6">
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" value="1" name="full_multiple_companies_support">
        ...
        <div class="row">
            ...
            <div
                class="form-group col-lg-6{{  (\App\Helpers\Helper::checkIfRequired(\App\Models\User::class, 'auto_increment_prefix')) ? ' required' : '' }} {{ $errors->has('auto_increment_prefix') ? 'error' : '' }}">
                ...
                {!! $errors->first('auto_increment_prefix', '<span class="alert-msg"
                    aria-hidden="true">:message</span>') !!}
            </div>

            <div
                class="form-group col-lg-6{{  (\App\Helpers\Helper::checkIfRequired(\App\Models\User::class, 'zerofill_count')) ? ' required' : '' }} {{ $errors->has('zerofill_count') ? 'error' : '' }}">
        ...
        <div class="row">
            ...
            <!-- email format  -->
            <div
                class="form-group col-lg-6{{  (\App\Helpers\Helper::checkIfRequired(\App\Models\User::class, 'email_format')) ? ' required' : '' }} {{ $errors->has('email_format') ? 'error' : '' }}">
        ...
        <div class="row">
            <!-- first name -->
            <div class="form-group col-lg-6 required {{ $errors->has('first_name') ? 'error' : '' }}">
        ...
        <div class="row">
            <!-- email-->
            <div
                class="form-group col-lg-6 @if(\App\Helpers\Helper::checkIfRequired(\App\Models\User::class, 'email')) required @endif {{ $errors->has('email') ? 'error' : '' }}">
            ...
            <!-- username -->
            <div class="form-group col-lg-6 required {{ $errors->has('username') ? 'error' : '' }}">
        ...
        <div class="row">
            <!-- password -->
            <div class="form-group col-lg-6 required {{ $errors->has('password') ? 'error' : '' }}">
            ...
            <!-- password confirm -->
            <div class="form-group col-lg-6 required {{ $errors->has('password_confirm') ? 'error' : '' }}">
