                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="checkbox">
                                <label for="activated">
                                    {{ Form::radio('activated', '', true, ['aria-label'=>'activated']) }} Do not change
                                    activation status <br>
                                    {{ Form::radio('activated', '1', old('activated'), ['aria-label'=>'activated']) }}
                                    User is activated<br>
                                    {{ Form::radio('activated', '0', old('activated'), ['aria-label'=>'activated']) }}
