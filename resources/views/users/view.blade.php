          ...
          <div class="row">
                ...
                <table class="table table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      @can('superadmin')
                      <a href="{{ route('groups.show', $group->id) }}" class="label label-default">{{ $group->name
                        }}</a>
                      @else
                      {{ $group->name }}
                      @endcan
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('users.show', $user->manager->id) }}">{{ $user->manager->getFullNameAttribute()
                        }}</a>
                  ...
                  <tr>
                    ...
                    <td><a href="{{ route('departments.show', $user->department) }}">{{ $user->department->name }}</a>
                    </td>
                  </tr>
                  @endif
                  @if ($user->created_at)
                  ...
                  <tr>
                    ...
                    <td>
                      {!! ($user->activated=='1') ? '<i class="fa fa-check text-success" aria-hidden="true"></i>
                      '.trans('general.yes') : '<i class="fa fa-times text-danger" aria-hidden="true"></i>
                      '.trans('general.no') !!}
                  </tr>
                  <tr>
                    <td class="text-nowrap">LDAP</td>
                    <td>
                      {!! ($user->ldap_import=='1') ? '<i class="fa fa-check text-success" aria-hidden="true"></i>
                      '.trans('general.yes') : '<i class="fa fa-times text-danger" aria-hidden="true"></i>
                      '.trans('general.no') !!}
                  ...
                  <tr>
                    ...
                    <td>
                      {!! ($user->two_factor_active()) ? '<i class="fa fa-check text-success" aria-hidden="true"></i>
                      '.trans('general.yes') : '<i class="fa fa-times text-danger" aria-hidden="true"></i>
                      '.trans('general.no') !!}
                    </td>
                  </tr>
                    ...
                    <td class="two_factor_resetrow">
                      <div class="row">
                        <div class="col-md-2" id="two_factor_reset_toggle">
                          {!! ($user->two_factor_active_and_enrolled()) ? '<i class="fa fa-check text-success"
                            aria-hidden="true"></i> '.trans('general.yes') : '<i class="fa fa-times text-danger"
            ...
            <div class="col-md-2">
              ...
              <div class="col-md-12" style="padding-top: 5px;">
                <a href="{{ route('clone/user', $user->id) }}" style="width: 100%;"
              ...
              @else
              <div class="col-md-12" style="padding-top: 5px;">
                <a href="{{ route('restore/user', $user->id) }}" style="width: 100%;"
                  class="btn btn-sm btn-warning hidden-print">{{ trans('button.restore') }}</a>
              </div>
              @endif
              @endcan
            </div>
        ...
        <div class="tab-pane" id="asset">
          ...
          <div class="table-responsive table-striped">
            <table data-click-to-select="true" data-columns="{{ \App\Presenters\AssetPresenter::dataTableLayout() }}"
              ...
              data-show-columns="true" data-show-export="true" data-show-footer="true" data-show-refresh="true"
              data-sort-order="asc" data-sort-name="name" data-toolbar="#toolbar" id="userAssetsListingTable"
        ...
        <div class="tab-pane" id="licenses">
          <div class="table-responsive">
            <table data-cookie-id-table="userLicenseTable" data-id-table="userLicenseTable" id="userLicenseTable"
              ...
              data-sort-name="name" class="table table-striped snipe-table table-hover" data-export-options='{
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="hidden-print">
                    ...
                    <a href="{{ route('checkin/accessory', array('accessoryID'=> $accessory->pivot->id, 'backto'=>'user')) }}"
                      class="btn btn-primary btn-sm hidden-print">{{ trans('general.checkin') }}</a>
                    @endcan
                  </td>
                </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn delete-asset btn-danger btn-sm hidden-print"
                          ...
                          data-title="Delete {{ $file->filename }}?"><i class="fa fa-trash icon-white"
                            aria-hidden="true"></i><span class="sr-only">Delete</span></a>
                        @endcan
                      </td>
                    </tr>
                    @endforeach
        ...
        <div class="tab-pane" id="history">
          <div class="table-responsive">
            ...
            <table data-click-to-select="true" data-cookie-id-table="usersHistoryTable" data-pagination="true"
              ...
              data-show-columns="true" data-show-export="true" data-show-refresh="true" data-sort-order="desc"
              data-toolbar="#toolbar" id="usersHistoryTable" class="table table-striped snipe-table"
              ...
              <thead>
                <tr>
                  ...
                  <th class="col-sm-2" data-field="admin" data-formatter="usersLinkObjFormatter">{{
        ...
        <div class="tab-pane" id="managed">
          <div class="table-responsive">
            <table class="display table table-striped">
              ...
              <tbody>
                @foreach ($user->managedLocations()->get() as $location)
                <tr>
